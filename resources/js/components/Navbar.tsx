  ...
  const baseNavigation = [
    ...
    { 
      ...
      dropdown: [
        ...
        { name: 'Conference Schedule', href: '/assets/download/ICMA-SURE 8th Schedule.pdf', isDownload: true },
        { name: 'Registration Guide', href: 'https://youtube.com/watch?si=N5GrRh3AwPOP81HA&v=6kS_7XpLTfg&feature=youtu.be', isExternal: true },
        ...
        { name: 'Presenter Guidelines', href: '/presenter-guidelines' }
      ] 
    },
    { 
