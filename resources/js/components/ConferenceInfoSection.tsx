...
const ConferenceInfoSection: React.FC<ConferenceInfoSectionProps> = ({
  ...
  const journals: JournalInfo[] = [
    { 
      ...
      type: "Journal", 
      indexed: "Scopus Q4",
      url: "https://jos.unsoed.ac.id/index.php/jm/"
    },
    { 
      name: "Jurnal Keperawatan Soedirman", 
      type: "Journal", 
      indexed: "Scopus Q4",
      url: "https://jos.unsoed.ac.id/index.php/jks/index"
    },
    { 
      name: "Journal of the Chinese Institute of Civil and Hydraulic Engineering", 
      type: "Journal", 
      indexed: "Scopus Q4",
      url: "https://www.ipress.tw/J0126"
    }
  ];
                ...
                <div className="relative z-10">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8 max-w-6xl mx-auto">
                    {journals.map((journal, index) => (
                      <motion.div 
                        key={index} 
                        className="rounded-xl bg-gradient-to-r p-[1px] from-[#4CB050] via-[#F0A023] to-[#E52531] hover:shadow-lg transition-all duration-300"
                      ...
                      >
                        ...
                        >
                          <div className="h-full bg-white dark:bg-gray-800 rounded-xl p-6 text-center hover:bg-gray-50 dark:hover:bg-gray-750 transition-colors duration-300">
                            ...
                            <Title level={5} className="text-gray-900 dark:text-white mb-2 text-sm font-semibold hover:text-[#4CB050] transition-colors duration-300">
                              {journal.name}
                            </Title>
                            ...
                            {journal.indexed && (
                              <div className="inline-block px-2 py-1 rounded-full bg-gray-100 dark:bg-gray-700 mb-3">
                                <Text className="text-xs text-gray-600 dark:text-gray-400">
                                  {journal.indexed}
                                </Text>
                              </div>
                            )}
                            <div className="flex items-center justify-center text-[#4CB050] mt-2">
                              <svg className="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
                              </svg>
                              <span className="text-xs font-medium">Visit Journal</span>
                            </div>
                          </div>
                        </a>
                      </motion.div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {[
                      ...
                      <div key={index} className={`p-4 rounded-xl border-2 transition-all duration-300 hover:shadow-lg ${
                        item.highlight 
                          ? 'border-[#4CB050] bg-gradient-to-r from-[#4CB050]/5 to-[#E52531]/5' 
