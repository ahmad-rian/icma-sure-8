...
import type { User as UserType, Country } from '@/types';
...
export default function Create({ users, countries }: Props) {
    ...
    const handleSubmit: FormEventHandler = (e) => {
        e.preventDefault();
        post(route('admin.user-profiles.store'));
    };

    const breadcrumbs = [
        { title: 'Dashboard', href: route('admin.dashboard') },
        { title: 'User Profiles', href: route('admin.user-profiles.index') },
        { title: 'Add New Profile', href: route('admin.user-profiles.create') },
    ];

    return (
        <AppSidebarLayout breadcrumbs={breadcrumbs}>
            <Head title="Add User Profile" />
            
            <div className="container py-6">
                <div className="flex justify-between items-center mb-6">
                    <h1 className="text-2xl font-semibold">Add User Profile</h1>
                    ...
                    <CardContent>
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <Button type="submit" disabled={processing}>
                                {processing ? 'Saving...' : 'Save User Profile'}
                            </Button>
                        </form>
                    </CardContent>
                </Card>
